...
Configure GSD settings interactively — workflow toggles, advanced knobs, integrations, model profile, provider routing / cross-AI delegation, context window, and runtime output — with a single consolidated command.
