...
**Total commands:** 83 (see [`docs/INVENTORY.md`](INVENTORY.md#commands) for the full roster).
...
**Total workflows:** 81 (see [`docs/INVENTORY.md`](INVENTORY.md#workflows) for the full roster).
...
├── commands/gsd/*.md               # 83 slash commands
├── get-shit-done/
