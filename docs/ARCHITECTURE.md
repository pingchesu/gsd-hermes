...
**Total commands:** 67 (see [`docs/INVENTORY.md`](INVENTORY.md#commands) for the full roster).
...
├── commands/gsd/*.md               # 67 slash commands; local Claude installs use slash commands instead of global skills
├── get-shit-done/
